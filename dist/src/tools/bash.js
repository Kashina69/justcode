...
export class BashTool {
    static runningProcesses = new Set();
    definition = {
        name: 'bash',
    ...
    async execute(args) {
        return new Promise((resolve) => {
            ...
            child.stdout?.on('data', (data) => {
                ...
                if (lower.includes('server running') ||
...
// ─── WaitProcessTool ──────────────────────────────────────────────────────────
export class WaitProcessTool {
    definition = {
        name: 'wait_process',
        description: 'Polls a background process until it completes or the timeout is reached. ' +
