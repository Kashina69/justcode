 ...
 */
export async function runDbSchema(context, config) {
 ...
 */
export async function runDbQuery(context, config, input) {
 ...
 */
export async function runDbRevalidate(context, config) {
 ...
 */
export async function runDbMemoryList() {
    try {
 ...
 */
export async function runDbAsk(context, config, input) {
...
`;
        const orchestratorOptions = {
            ...
            registry: context.orchestrator.registry,
            safetyGate: context.orchestrator.safetyGate,
            backupManager: context.orchestrator.backupManager,
            onConfirmDangerousTool: context.orchestrator.onConfirmDangerousTool,
            systemPrompt,
        };
