...
export const PRICING_RATES: Record<string, PriceRates> = {
 ...
 */
export function getPricingRates(modelId: string): PriceRates {
...
// Provider specific default profiles (used in onboarding/config)
